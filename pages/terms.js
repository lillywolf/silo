export default function Terms() {
    return (
        ...
        <div className='terms px-10 block text-left text-sm md:text-lg pt-40 mx-auto'>
            <p className="text-lg"><a href="/covid">COVID-19 Policy</a></p>
            ...
            <p>Please read these Terms carefully before you start using the Website. By using the Website, you represent to us that you are over the age of 13, you are competent and have the power to enter into a binding agreement with us, and you accept and agree to be bound and abide by these Terms of Use and our <a href="/privacy">Privacy Policy</a>, and incorporated herein by reference. If you cannot or do not agree to these Terms of Use or our Privacy Policy, do not access or use the Website.</p>
            ...
            <p>We may withdraw or change the Website, and any service, feature or material we provide on the Website, in our sole discretion without notice. We will not be liable if for any reason all or any part of the Website is unavailable at any time or for any period. From time to time, we may restrict access to some parts of the Website, or the entire Website.</p>

            <p>To access the Website, or some of the resources it offers, you may be asked to provide certain details or other information. It is a condition of your use of the Website that all the information you provide on the Website is correct, current, and complete. You agree that all information you provide on the Website or otherwise, including, but not limited to, through the use of any interactive features on the Website, is governed by our Privacy Policy, and you consent to all actions we take with respect to your information consistent with our Privacy Policy.</p>

            <p><b>Intellectual Property Rights</b></p>

            <p>The Website, including its entire contents, features, and functionality (including, but not limited to, all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof), are owned by us, our licensors, or other providers of such material, and are protected by United States and international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.</p>
            ...
            <p>You may use the Website only in accordance with these Terms of Use. You agree not to use the Website:</p>
            ...
            <ul>
            <li>Use the Website in any manner that could disable, overburden, damage, or impair our Website or interfere with any other person’s use of the Website.</li>
            ...
            <li>Attempt to gain unauthorized access to, interfere with, damage, or disrupt any parts of the Website, the server on which the Website is stored, or any server, computer, or database connected to the Website, or otherwise attempt to interfere with the proper working of the Website.</li>
            <li>Introduce any virus, trojan horse, worm, logic bomb or other material, software or routine which is malicious or may presently or in the future be technologically harmful.</li>
            <li>Attack the Website in any manner, including via a denial-of-service attack or a distributed denial-of-service attack.</li>
            ...
            <p><b>Use of Website and Reliance on Information</b></p>
            ...
            <p>The Website may contain links to, or otherwise may allow you to connect to and use certain third party products, services or software under separate terms and conditions, including the purchase or reservation of tickets to certain events or venues through one or more third-party ticketing services (collectively, “Other Services”). The policies and procedures described here do not apply to the Other Services. The availability of a link or functionality provided through Other Services on the Website does not imply that we endorse or have reviewed such Other Services. We suggest that you contact the providers of such Other Services directly for information on their privacy policies.</p>
            ...
            <li>Cause the Website or portions of it to be displayed on, or appear to be displayed by, any other site, for example, framing, deep linking, or inline linking.</li>
            ...
            <p>THE DISCLAIMERS IN THIS SECTION DO NOT AFFECT ANY WARRANTIES THAT CANNOT BE EXCLUDED OR LIMITED UNDER APPLICABLE LAW.</p>
            ...
            <p>All matters relating to the Website and these Terms, and any dispute or claim arising from, or related, to them (in each case, including non-contractual disputes or claims), will be governed by and construed in accordance with the internal laws of New York, the United States without giving effect to any choice or conflict of law provision or rule (whether of New York, the United States or any other jurisdiction).</p>

            <p>Any suit, action, or proceeding arising out of, or related to, these Terms or the Website must be instituted exclusively in the federal courts of the United States or the courts of the State of New York in each case located in the City of New York. However, we may bring any suit, action, or proceeding against you for breach of these Terms in your country of residence or any other relevant country. You waive any and all objections to the exercise of jurisdiction over you by such courts and to venue in such courts.</p>

            <p><b>Limitation on Liability</b></p>

            <p>Furthermore, as a condition of access to the Website, you fully waive and release the Company’s shareholders, partners, affiliates, directors, officers, parents, subsidiaries, employees, agents, suppliers, licensees, and distributors from any and all claims, demands and damages of every kind and nature, whether known or unknown, suspected or unsuspected, disclosed or undisclosed, arising out of or in any way connected with your use of the Site, other users’ use of the Website, User Content posted on the Website, any interactions you have with the third parties whose services are advertised on the Website, and any dispute you have or claim to have against the Company and its affiliates or one or more users on the Website.</p>

            <p><b>Limitation on Time to File Claims</b></p>

            <p>ANY CAUSE OF ACTION OR CLAIM YOU MAY HAVE ARISING OUT OF OR RELATING TO THESE TERMS OR THE WEBSITE MUST BE COMMENCED WITHIN ONE (1) YEAR AFTER THE CAUSE OF ACTION ACCRUES; OTHERWISE, SUCH CAUSE OF ACTION OR CLAIM WILL BE PERMANENTLY BARRED.</p>

            <p><b>Waiver and Severability</b></p>

            <p>No waiver by us of any term or condition in these Terms will be deemed a continuing waiver of such term or condition or a waiver of any other term or condition. Any failure by us to assert a right or provision under these Terms will not constitute a waiver of such right or provision.</p>

            <p>If any provision of these Terms is held by a court or other tribunal of competent jurisdiction to be invalid, illegal, or unenforceable for any reason, such provision will be eliminated or limited to the minimum extent so that the remaining provisions of the Terms will continue in full force and effect.</p>

            <p><b>Entire Agreement</b></p>

            <p>These Terms and our <a href="/privacy">Privacy Policy</a> constitute the sole and entire agreement between you and us regarding the Website and supersede all prior and contemporaneous understandings, agreements, representations, and warranties, both written and oral, regarding the Website.</p>

            <p><b>Your Comments and Concerns</b></p>

            <p>This Website is operated by Silo Brooklyn LLC, 90 Scott Ave, Brooklyn NY 11237.</p>
            <p>All other feedback, comments, requests for technical support, and other communications relating to the Website must be directed to: contact@silobrooklyn.com</p>
