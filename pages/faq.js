export default function Policies() {
    return (
        <div className='policies mt-40 pb-40 px-10 mx-auto w-full md:w-3/4'>
            ...
            <p className='answer'>All of our events are 21+ unless otherwise specified. For 21+ events, all guests must show their government-issued photo identification or passport upon entry.</p>
            <h3 className='bold mb-4'>Safer Spaces</h3>
            <p className='prompt'>How does SILO promote a Safer Space?</p>
            <p className='answer'>SILO is a space for people to dance, to hear music, and to express themselves. While you are here, we want you to feel safe, comfortable, and at home. We do not tolerate violence, harassment, racism, homophobia, transphobia, or bigotry of any kind. We do not allow unwanted contact. This includes leering, staring, and cutting off someone else’s ability to move freely.</p>
            <p className='prompt'>What if I experience inappropriate behavior from someone?</p>
            <p className='answer'>If you experience behavior that is threatening or that makes you uncomfortable, please approach a staff member. Our staff is trained to handle these situations, and we will actively remove individuals who make others feel unsafe.</p>
            <h3 className='bold mb-4'>Accessibility</h3>
            ...
            {/* <p className='prompt'>Its gonna be a hot night, but I got this mink coat on me...you guys got a coat check?</p>
            <p className='answer'>There is a designated smoking area just outside the side door to the right of the stage. There will be a member of our security team at the door who will check your stamp upon re-entering the venue.</p> */}
