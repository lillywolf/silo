        ...
        <>
            ...
            <div className='absolute w-full text-left'>
                <div className='relative mt-40 mb-40 w-9/12 text-s mx-auto lg:w-6/12'>
                    ...
                    <br></br>
                    <p>2 x Danley SH96HO 2800W mains</p>
                    <p>2 x Danley BC218 6800W main subwoofers (low-end extension down to 22 Hz)</p>
                    <p>2 x Danley SH46 2800W rear fills</p>
                    <p>2 x Danley TH115 rear subwoofer fills (2000W each)</p>
                    <p>4 x Danley 20K4 amplifiers (total 80,000 watts amplifier power)</p>
                    <p>2 x Danley SM60F 1600W DJ booth monitors</p>
                    <p>2 x Danley TH115 2000W DJ booth sub monitors</p>
                    <p>Allen & Heath SQ-5 digital mixer (48 channels, 96kHz processing) with AR2412 and AB168 digital stage boxes</p>
                    <p>2 x Electro-Voice ELX200-12P 1200W 2-Way powered loudspeaker stage fills</p>
                    <p>2 x Electro-Voice ETX200-12P 2000W 2-Way powered loudspeaker mid room fills</p>
                    <br></br>
                    ...
                    <br></br>
                    <p className='text-white'>INSTRUMENT AMPLIFIERS</p>
                    <br></br>
                    ...
                    <br></br>
                    <p>88-key weighted Yamaha Motif keyboard</p>
                    <p>PDP Centerstage 5-piece drum kit. Drummers must bring snare, cymbals, and additional hardware if they need more than a hi-hat and two cymbal stands.</p>
                    <p>Pioneer XDJ-RX2 DJ Controller (compatible with Rekordbox)</p>
                    <br></br>
                    ...
                    <p>PC with three touch screens, GrandMA 2 Command Wing and 2 X Fader Wing Control Boards</p>
                    <p>Windows laptop with Pangolin Quickshow and an Akai APC Mini MK2 Controller for laser control</p>
                    <br></br>
