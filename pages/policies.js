        ...
        <>
            ...
            <div className='relative w-2/3 mt-40 min-h-screen mx-auto text-lg policies'>
                ...
                <div className='mt-4'>
                    ...
                    <p>We are signatories to the Palestinian Campaign for the Academic and Cultural Boycott of Israel (<span className="newsletter-link"><Link className="newsletter-link" target="_blank" href="https://bdsmovement.net/pacbi/cultural-boycott-guidelines">PACBI</Link></span>) and pledge to boycott all institutions and funders complicit in the Israeli occupation and genocide.</p>
                    <br/>
                    ...
                    <ul>
                        ...
                        <li className='ml-4'>&bull; refuse “normalization” efforts seeking to justify Israel&apos;s violence or present a false symmetry between oppressed and oppressor.</li>
                    ...
                    <br/>
                    <p>PACBI rejects on principle boycotts of individuals based on their identity (such as citizenship, race, gender, sexuality, or religion) or opinion. Mere affiliation of Israeli cultural workers to an Israeli cultural institution is therefore not grounds for applying the boycott. If, however, an individual is representing the state of Israel or a complicit Israeli institution, or is commissioned/recruited to participate in Israel&apos;s efforts to “rebrand” itself, then their activities are subject to this institutional boycott the PACBI movement is calling for.</p>
                    <br/>
