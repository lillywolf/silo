        ...
        <>
            <div className="text-left text-white w-full">
                ...
                <div className='absolute mt-24 ml-12'>
                    <strong className="text-3xl">Drinks</strong>
                    <div className="font">From mixologist Daniel Roman</div>
                    <p>&nbsp;</p>

                    <div>
                        <h3 className="text-xl">The Perfect Tequila Soda</h3>
                        <p>Casamigos Tequila, Fever Tree Club Soda, Lime </p>
                        <p>17</p>
                        <p>&nbsp;</p>
                    </div>

                    <div>
                        <h3 className="text-xl">The Perfect Gin &amp; Tonic</h3>
                        <p>Hendrick’s Gin, Fever Tree Tonic, Lime</p>
                        <p>17</p>
                        <p>&nbsp;</p>
                    </div>
                    ...
                    <p>&nbsp;</p>
                    <div>
                        <h2 className="text-2xl">Non-Alcoholic</h2>
                        <h3 className="text-xl">Brooklyn Brewery Hoppy Amber NA Beer</h3>
                        <p>7</p>
                        <p>&nbsp;</p>
                    </div>

                    <div>
                        <h3 className="text-xl">The Ariel</h3>
                        <p>Perrier Strawberry Seltzer, Caffeinated Flavor Crystals</p>
                        <p>5</p>
                        <p>&nbsp;</p>
                    </div>

                    <div>
                        <h3 className="text-xl">White Label Yerba Mate Soda</h3>
                        <p>5</p>
                        <p>&nbsp;</p>
                    </div>

                    <div>
                        <h3 className="text-xl">Red Bull</h3>
                        <p>5</p>
                        <p>&nbsp;</p>
                    </div>

                    <div>
                        <h3 className="text-xl">Liquid Death Mountain or Sparkling Water</h3>
                        <p>4</p>
                        <p>&nbsp;</p>
                    </div>

                    <div>
                        <h3 className="text-xl">Perrier Strawberry or Lime Flavor</h3>
                        <p>3</p>
                        <p>&nbsp;</p>
                    </div>

                    <div>
                        <h3 className="text-xl">Assorted Seasonal Hot Teas</h3>
                        <p>3</p>
                        <p>&nbsp;</p>
                    </div>
                    ...
                    <h2 className="text-2xl">Snacks</h2>

                    <div>
                        <h3 className="text-xl">Pork Rinds (Korean BBQ, Salt &amp; Pepper</h3>
                        <p>3</p>
                        <p>&nbsp;</p>
                    </div>
